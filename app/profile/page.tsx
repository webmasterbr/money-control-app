  ...
  return (
    <div className="space-y-6">
      ...
      <section className="card p-4">
        <h2 className="text-xs font-medium uppercase text-slate-400">Nome</h2>
        <p className="mt-2 text-sm text-slate-100">{displayName(user)}</p>

        <h2 className="mt-4 text-xs font-medium uppercase text-slate-400">
          E-mail
        </h2>
